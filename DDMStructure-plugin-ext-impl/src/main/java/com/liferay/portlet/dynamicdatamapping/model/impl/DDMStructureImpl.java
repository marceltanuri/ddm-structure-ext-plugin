...
public class DDMStructureImpl extends DDMStructureBaseImpl {
	...
	@Override
	public List<String> getChildrenFieldNames(String fieldName) throws PortalException, SystemException {
	...
	@Override
	public String getFieldDataType(String fieldName) throws PortalException, SystemException {

		return getFieldProperty(fieldName, "dataType");
	}

	@Override
	public String getFieldLabel(String fieldName, Locale locale) throws PortalException, SystemException {

		return getFieldLabel(fieldName, LocaleUtil.toLanguageId(locale));
	}

	@Override
	public String getFieldLabel(String fieldName, String locale) throws PortalException, SystemException {

		return GetterUtil.getString(getFieldProperty(fieldName, "label", locale), fieldName);
	}
	...
	@Override
	public String getFieldProperty(String fieldName, String property) throws PortalException, SystemException {

		return getFieldProperty(fieldName, property, getDefaultLanguageId());
	}

	@Override
	public String getFieldProperty(String fieldName, String property, String locale)
	...
	@Override
	public boolean getFieldRepeatable(String fieldName) throws PortalException, SystemException {

		return GetterUtil.getBoolean(getFieldProperty(fieldName, "repeatable"));
	}

	@Override
	public boolean getFieldRequired(String fieldName) throws PortalException, SystemException {
	...
	public Map<String, String> getFields(String fieldName, String attributeName, String attributeValue) {
		...
		return getFields(fieldName, attributeName, attributeValue, getDefaultLanguageId());
	}
	...
	public Map<String, String> getFields(String fieldName, String attributeName, String attributeValue, String locale) {
		...
		try {
			...
			Map<String, Map<String, String>> fieldsMap = getTransientFieldsMap(locale);

			for (Map<String, String> fields : fieldsMap.values()) {
				String parentName = fields.get(_getPrivateAttributeKey("parentName"));
	...
	@Override
	public Map<String, Map<String, String>> getFieldsMap(String locale) throws PortalException, SystemException {

		return getFieldsMap(locale, false);
	}

	@Override
	public Map<String, Map<String, String>> getFieldsMap(String locale, boolean includeTransientFields)
			throws PortalException, SystemException {
	...
	@Override
	public String getFieldTip(String fieldName, Locale locale) throws PortalException, SystemException {

		return getFieldTip(fieldName, LocaleUtil.toLanguageId(locale));
	}

	@Override
	public String getFieldTip(String fieldName, String locale) throws PortalException, SystemException {

		return GetterUtil.getString(getFieldProperty(fieldName, "tip", locale), fieldName);
	}

	@Override
	public String getFieldType(String fieldName) throws PortalException, SystemException {
	...
	public Map<String, Map<String, Map<String, String>>> getLocalizedFieldsMap() {
		...
		if (_localizedFieldsMap == null) {
			_localizedFieldsMap = new ConcurrentHashMap<String, Map<String, Map<String, String>>>();
		}
	...
	public Map<String, Map<String, Map<String, String>>> getLocalizedPersistentFieldsMap() {
		...
		if (_localizedPersistentFieldsMap == null) {
			_localizedPersistentFieldsMap = new ConcurrentHashMap<String, Map<String, Map<String, String>>>();
		}
	...
	public Map<String, Map<String, Map<String, String>>> getLocalizedTransientFieldsMap() {
		...
		if (_localizedTransientFieldsMap == null) {
			_localizedTransientFieldsMap = new ConcurrentHashMap<String, Map<String, Map<String, String>>>();
		}
	...
	public Map<String, Map<String, String>> getPersistentFieldsMap(String locale)
		...
		Map<String, Map<String, String>> fieldsMap = localizedPersistentFieldsMap.get(locale);
	...
	public Map<String, Map<String, String>> getTransientFieldsMap(String locale)
		...
		Map<String, Map<String, String>> fieldsMap = localizedTransientFieldsMap.get(locale);
	 ...
	 *                     HTTPS access, the server name, the server port, the path
	...
	@Override
	public boolean isFieldPrivate(String fieldName) throws PortalException, SystemException {

		return GetterUtil.getBoolean(getFieldProperty(fieldName, "private"));
	}

	@Override
	public boolean isFieldRepeatable(String fieldName) throws PortalException, SystemException {

		return GetterUtil.getBoolean(getFieldProperty(fieldName, "repeatable"));
	}

	@Override
	public boolean isFieldTransient(String fieldName) throws PortalException, SystemException {

		if (!hasField(fieldName)) {
			throw new StructureFieldException();
		}

		Map<String, Map<String, String>> transientFieldsMap = getTransientFieldsMap(getDefaultLanguageId());
	...
	public void prepareLocalizedFieldsForImport(Locale defaultImportLocale) throws LocaleException {
		...
		try {
			setXsd(DDMXMLUtil.updateXMLDefaultLocale(getXsd(), ddmStructureDefaultLocale, defaultImportLocale));
		} catch (Exception e) {
	...
	public void setLocalizedPersistentFieldsMap(
			Map<String, Map<String, Map<String, String>>> localizedPersistentFieldsMap) {
	...
	private Map<String, String> _getField(Element element, String locale) {
		...
		if ((locale != null) && !ArrayUtil.contains(availableLanguageIds, locale)) {
	...
	private String _getPrivateAttributeKey(String attributeName) {
		return StringPool.UNDERLINE.concat(attributeName).concat(StringPool.UNDERLINE);
	}
	...
	private Map<String, String> _getPrivateField(String privateFieldName) {
		...
		String dataType = PropsUtil.get(PropsKeys.DYNAMIC_DATA_MAPPING_STRUCTURE_PRIVATE_FIELD_DATATYPE,
		...
		String repeatable = PropsUtil.get(PropsKeys.DYNAMIC_DATA_MAPPING_STRUCTURE_PRIVATE_FIELD_REPEATABLE,
				new Filter(privateFieldName));
	...
	private void _indexFieldsMap(String locale) throws PortalException, SystemException {
		...
		Map<String, Map<String, String>> persistentFieldsMap = localizedPersistentFieldsMap.get(locale);
	...
	@CacheField
	private Map<String, Map<String, Map<String, String>>> _localizedPersistentFieldsMap;

	@CacheField
	private Map<String, Map<String, Map<String, String>>> _localizedTransientFieldsMap;
